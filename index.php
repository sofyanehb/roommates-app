  ...
  <div class="row align-items-center g-4 position-relative" style="z-index: 1;">
    <div class="col-lg-7">
      ...
      <p class="lead-copy mb-4">
        <?php if ($loggedIn): ?>
          Continue your roommate workflow with your dashboard, chat inbox, and shortlist. Everything is synced to your account session.
        <?php else: ?>
          Built as a professional PHP and MySQL product concept, the platform combines secure onboarding, structured listings, and fast search to replace fragmented social-media roommate hunting.
        <?php endif; ?>
      </p>
...
<section class="row g-4 mb-4 mb-lg-5">
      ...
      <div class="row g-3">
        <div class="col-md-6">
          <div class="feature-card h-100 p-4">
            ...
            <p class="mb-0 copy-muted">Passwords are hashed, sessions protect private pages, and the data model is normalized for future growth.</p>
          </div>
        </div>
        <div class="col-md-6">
          <div class="feature-card h-100 p-4">
            <div class="badge-soft mb-3">Speed</div>
            <p class="mb-0 copy-muted">Structured filters, reusable helpers, and a direct user flow keep the experience simple and fast.</p>
          </div>
        </div>
        <div class="col-md-6">
          <div class="feature-card h-100 p-4">
            <div class="badge-soft mb-3">Engagement</div>
            <p class="mb-0 copy-muted">Listings, search, and optional messaging create a clean funnel from discovery to contact.</p>
          </div>
        </div>
        <div class="col-md-6">
          <div class="feature-card h-100 p-4">
            <div class="badge-soft mb-3">Scalability</div>
            <p class="mb-0 copy-muted">The codebase separates pages, actions, and shared helpers, which makes future features easy to add.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-lg-4">
    <div class="surface-card p-4 h-100">
      ...
      <ul class="list-unstyled d-grid gap-2 mb-0 copy-muted">
